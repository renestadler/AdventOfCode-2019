...
switch (dayNr) {
    ...
    case 6:
        ...
        break;
    case 7:
        (d07.Main.start(readInput("7.test"))).then(v =>
            console.log("TestInput:\t" + v));
        (d07.Main.start(readInput("7.in"))).then(v =>
            console.log("Input:\t\t" + v));
        break;
    case 8:
    ...
    case 22:
        ...
        break;
    case 23:
        (d23.Main.start(readInput("23.test"))).then(v =>
            console.log("TestInput:\t" + v));
        (d23.Main.start(readInput("23.in"))).then(v =>
            console.log("Input:\t\t" + v));
        break;
    case 24:
